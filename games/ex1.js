...
checkMatch = () => {
  if(cardsFlipped === 2) {
    ...
    for (let i = 0 ; i < cardArray.length ; i++) {
      if(grid$$.childNodes[i].src !== "http://127.0.0.1:5500/games/public/exercise-1/universe.svg" && grid$$.childNodes[i].src !== "http://127.0.0.1:5500/games/public/exercise-1/tick.svg" && card1 === 15) card1 = i;
      if(grid$$.childNodes[i].src !== "http://127.0.0.1:5500/games/public/exercise-1/universe.svg" && grid$$.childNodes[i].src !== "http://127.0.0.1:5500/games/public/exercise-1/tick.svg" && card1 !== 15 && card2 === 15) card2 = i;
